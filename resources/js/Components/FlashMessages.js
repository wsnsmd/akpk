  ...
  return (
    <div>
      {flash.success && visible && (
        <div className="mb-8 flex items-center justify-between bg-green-50 rounded-md max-w-3xl border border-green-400">
          <div className="flex items-center">
            <CheckCircleIcon className="h-5 w-5 text-green-400 ml-2" aria-hidden="true" />
            <div className="py-4 ml-2 font-medium text-sm text-green-800">
              {flash.success}
            </div>
          </div>
      ...
      {(flash.error || numOfErrors > 0) && visible && (
        <div className="mb-8 flex items-center justify-between bg-red-50 rounded-md max-w-3xl border border-red-400">
          <div className="flex items-center">
          <XCircleIcon className="h-5 w-5 text-red-400 ml-2" aria-hidden="true" />
            <div className="py-4 ml-2 font-medium text-sm text-red-800">
